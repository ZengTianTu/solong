...
class AuthToken {
    ...
    public boolean isExpired() {
        LocalDateTime date =
                LocalDateTime.ofInstant(Instant.ofEpochMilli(createTime), ZoneId.of("Asia/Shanghai"));
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        AuthToken authToken = generate("http://localhost/login", 1581730218124l, "123456", "123456");
        System.out.println("Server Token :" + authToken.getToken());
    }
}
